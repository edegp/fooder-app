// https://github.com/vektah/gqlparser/blob/3596b2e4b6e6eb827ab01a0a35f28af3660896b1/formatter/formatter.goのcopy
package formatter
...
func (f *formatter) FormatSchema(schema *ast.Schema) {
	...
	//----------- edit here --------------//
	time, ok := schema.Types["Time"]
	if ok {
		f.FormatDefinition(time, false)
	}
